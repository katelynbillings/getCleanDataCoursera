...
# This function creates and returns a tidy data set from the Samsung Galaxy S 
# activity data, with the average of each variable for each activity and subject
